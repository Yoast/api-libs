...
class Yoast_Api_Google {
	...
	private function autoload_api_google_files( $class_name ) {
		...
		$oauth_files = array(
			...
			// Caching
			'yoast_google_filecache'       => 'google/cache/Google_FileCache',
			'yoast_google_memcachecache'   => 'google/cache/Google_MemcacheCache',
			'yoast_google_cacheparser'     => 'google/io/Google_CacheParser',

			// Requests
			'yoast_google_httprequest'     => 'google/io/Google_HttpRequest',
			'yoast_google_httpstream_io'   => 'google/io/Google_HttpStreamIO',
			...
			// REPLACE ME!
			'yoast_google_curlio'          => 'google/io/Google_CurlIO',
		);
